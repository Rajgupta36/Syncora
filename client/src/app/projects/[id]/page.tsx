    ...
    <div className="flex flex-col justify-start w-full gap-y-6 p-10">
      ...
      <div className="flex flex-col gap-y-4">
        ...
        <div className="flex justify-start items-center gap-x-4">
          <button
            className={`text-md text-secondary-950 px-2 ${isActiveTab === 'BOARD' ? 'font-semibold border-b-2 border-secondary-950' : ''}`}
            onClick={() => setIsActiveTab('BOARD')}
          >
            Board
          </button>
          <button
            className={`text-md text-secondary-950 px-2 ${isActiveTab === 'LIST' ? 'font-semibold border-b-2 border-secondary-950' : ''}`}
            onClick={() => setIsActiveTab('LIST')}
          >
            List
          </button>
          <button
            className={`text-md text-secondary-950 px-2${isActiveTab === 'GRAPH' ? 'font-semibold border-b-2 border-secondary-950' : ''}`}
