  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex',
        head_cell:
          'text-secondary-950  rounded-md w-9 font-normal text-[0.8rem] dark:text-neutral-400',
        ...
        day_selected:
          'bg-primary-600 text-white hover:bg-primary-600 hover:bg-opacity-20 hover:text-neutral-50 focus:bg-primary-600  focus:text-white dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900',
        day_today:
          'bg-secondary-950 text-white dark:bg-neutral-800 dark:text-neutral-50',
        day_outside:
        ...
        day_disabled: 'text-primary-600 opacity-50 dark:text-neutral-400',
        day_range_middle:
